...
import { ICountryReadDTO } from "@bus/domain/models/apis/platform/entities/country";
import { ICountryReadEntity } from "@bus/infrastructure/entities/apis/platform/entities/country";
