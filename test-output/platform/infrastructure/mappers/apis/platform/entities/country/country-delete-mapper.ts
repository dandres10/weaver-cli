...
import { ICountryDeleteDTO } from "@platform/domain/models/apis/platform/entities/country";
import { ICountryDeleteEntity } from "@platform/infrastructure/entities/apis/platform/entities/country";
